...
- **Patent** — Anomaly detection and management in compute environments (FR3164046, 2024)
- **IEEE Publications** — 4 papers in IEEE TMC, ITC, ICC on next-generation networks
